...
| pnpm                  | 11.10.0               | Package manager            | Pinned through `packageManager`/Corepack, GitHub Actions `PNPM_VERSION`, and Docker `PNPM_VERSION`. Requires Node.js 22.13+; ImportLens uses Node.js 24 LTS for all build infrastructure.                                                                                                                     |
