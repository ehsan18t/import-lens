...
10. Each completed import is written to `papaya` (memory) and `redb` (disk) — unless a transient engine failure degraded it (FR-026c) — and pushed to the client on the `refreshed_results` channel as it lands.
