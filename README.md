...
The default display mode uses VS Code inlay hints. ImportLens uses VS Code inlay hints by default because they are part of the editor document model and are exposed to accessibility tooling. End-of-line decorations remain available, but they are less accessible to screen readers.
